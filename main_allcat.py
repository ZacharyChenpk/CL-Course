...
class ModelArguments:
    ...
    softmax_temperature: Optional[float] = field(
        default=None,
        metadata={
            "help": "The temperature of softmax in loss calculation."
        },
    )
...
def main():
    ...
    if training_args.do_eval:
        ...
        with training_args.main_process_first(desc="indeed validation dataset map pre-processing"):
    ...
    if training_args.do_eval:
        ...
        metrics["dev_samples"] = min(max_eval_samples, len(dev_dataset))

        trainer.log_metrics("dev eval", metrics)
        trainer.save_metrics("dev eval", metrics)
        ...
        trainer.log_metrics("test eval", metrics)
        trainer.save_metrics("test eval", metrics)
